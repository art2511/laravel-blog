    ...
    <div>
        <div>
            <div class="border-4 rounded-md w-64 mt-6 mr-4 ml-2">
                <div class="text-2xl font-bold ml-2"><?php echo e(__('Login')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label for="password" class="text-2xl font-bold ml-2"><?php echo e(__('Password')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <div>
                                <div>
                                    <input class="text-xl ml-2" type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                        ...
                        <div>
                            <div>
                                ...
                                <?php if(Route::has('password.request')): ?>
                                    <a class="text-xl ml-2" href="<?php echo e(route('password.request')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\laravel-blog\resources\views/auth/login.blade.php ENDPATH**/ ?>